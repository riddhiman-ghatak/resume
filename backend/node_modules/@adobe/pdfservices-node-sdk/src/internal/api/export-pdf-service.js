...
class ExportPDFService extends PlatformOperationService {
	constructor() {
		super();
	}
	...
	getPlatformMessage(operationMessage) {
		...
		let options = (operationMessage.targetFormat) ? Object.assign({}, {
			targetFormat: operationMessage.targetFormat.extension
		}) : {};
		options = (operationMessage.options) ? Object.assign(options, operationMessage.options) : options;
		let operationApiName = PDFServicesConfig.exportPdf;
