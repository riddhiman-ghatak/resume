 ...
 * @enum
 * @memberOf CreatePDFFromExcelOptions
 * @readonly
 */
...
/**
 * Parameters for converting Excel Files to PDF using {@link CreatePDFOperation}.
 */
class CreatePDFFromExcelOptions {
	/**
	 * @hideconstructor
	 * @param builder
	 */
	 ...
	 * @memberOf CreatePDFFromExcelOptions
	 * @function
	 * @returns {CreatePDFFromExcelOptionsBuilder} A Builder instance for initializing {@link CreatePDFFromExcelOptions}.
	 */
	static get Builder() {
		/**
		 *
		 * Builds a {@link CreatePDFFromExcelOptions} instance.
		 */
		class CreatePDFFromExcelOptionsBuilder {
			/**
			 * Constructs a {@link CreatePDFFromExcelOptionsBuilder} instance.
			 */
			constructor() {
			}
			 ...
			 * @param {!CreatePDFFromExcelOptions.SupportedDocumentLanguage} documentLanguage - see {@link CreatePDFFromExcelOptions.SupportedDocumentLanguage}. Default value is
			 * {@link CreatePDFFromExcelOptions.SupportedDocumentLanguage.EN_US}
			 * @returns {CreatePDFFromExcelOptionsBuilder} This Builder instance to add any additional parameters.
			 */
			...
			/**
			 * Returns a new {@link CreatePDFFromExcelOptions} instance built from the current state of this builder.
			 * @returns {CreatePDFFromExcelOptions} A CreatePDFFromExcelOptions instance.
			 */
			build() {
				let createPDFFromExcelOptions =  new CreatePDFFromExcelOptions(this);
				Object.freeze(createPDFFromExcelOptions);
				return createPDFFromExcelOptions;
			}
		}

		return CreatePDFFromExcelOptionsBuilder;
	}
...
module.exports = CreatePDFFromExcelOptions;
